...
| `src/variables.js` | 29 variables — track info, timing, shuffle, repeat, liked, api_status |
| `src/presets.js` | ~95 presets across 15 categories |
...
- Bookmark resume: playlist/album contexts use `playContextAtTrackUri` + 1.5s delay + seek; artist/show/none falls back to direct `playTrack`
